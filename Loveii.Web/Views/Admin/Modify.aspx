...
<div>  
    ...
    <p>标　题：<input type="text" id="title" name="title"  value="<%=Model.Post.title %>"</p>
    <p>简　介：<textarea id="excerpt" name="excerpt" ><%=Model.Post.excerpt %></textarea></p>
    <p><script id="editor" type="text/plain" style="width:1024px;height:500px;"><%=Model.Post.content %></script></p>  
